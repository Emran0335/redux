      ...
      <nav className="bg-[#171c2a] py-4">
        <div className="w-full mx-auto flex items-center justify-between px-[0.25rem]">
          ...
          <div className="flex gap-4">
            <a
              href="#"
              className="text-[1.25rem] leading-[1.75rem] text-yellow-50"
            ...
            <a
              href="#"
              className="flex items-center justify-center rounded-full px-[1.5rem] pt-[0.25rem] pb-[0.25rem] bg-[#c15dc1] text-yellow-50 font-semibold"
